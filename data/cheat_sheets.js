/* ==========================================================================
   GCP ACE Prep Pro - Visual Cheat Sheets & Quick Recap Data
   ========================================================================== */

window.CHEAT_SHEETS = {
    storage: {
        title: "🗄️ Cloud Storage & Database Options",
        subtitle: "Mastering data persistence, relational scaling, and NoSQL selection for the ACE exam.",
        flowchart: {
        ...
        services: [
            {
                ...
                gotcha: "Remember: Changing storage class does not change bucket location. Use Signed URLs for temporary secure access."
            },
            {
                name: "Cloud SQL",
            ...
            },
            {
                ...
                gotcha: "Replaces Cloud Datastore. Queries scale with the size of the result set, not the size of the entire database!"
            },
            {
                name: "Cloud Bigtable",
    ...
    compute: {
        ...
        subtitle: "Selecting the optimal compute abstraction based on control, portability, and serverless automation.",
        flowchart: {
        ...
        services: [
            ...
            },
            {
                ...
                gotcha: "In GKE Autopilot, you pay strictly for the CPU, memory, and storage requested by your running pods, not the underlying compute VMs."
            },
            {
                name: "App Engine (GAE)",
    ...
    iam: {
        ...
        subtitle: "Enforcing least privilege, identity federation, and hierarchical resource boundaries.",
        flowchart: {
    ...
    networking: {
        ...
        subtitle: "Architecting global virtual private clouds, load balancers, and hybrid corporate interconnects.",
        flowchart: {
    ...
    operations: {
        ...
        subtitle: "Observability, centralized logging, alerting policies, and performance tracing.",
        flowchart: {
